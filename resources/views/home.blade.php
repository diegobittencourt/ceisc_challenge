									...
									<div class="col-12">
										<div class="card">
											<div class="card-header" style="background-color: #e6f2ff;">
												<div class="row">
													<div class="col-9">														
														<h2><b id="titulo_{{ $postagem->id }}"> {{ $postagem->titulo }}</b></h2>
													</div>
													<div class="col-1">
											...
											<div class="card-body" style="">
												...
												<div id="div_edita_imagem_{{ $postagem->id }}" style="display: none;" class="mb-3">
													...
													<button id="btn_edita_imagem_{{ $postagem->id }}" disabled type="button" class="btn btn-default btn-md" onclick="salvaImagem({{$postagem->id}})">
														<b>Trocar Imagem</b>
													</button>
							...
							@else
								<div class="col-12">
									<div class="alert alert-warning" role="alert">
										Ainda não foram criadas postagens no BLOG.
									</div>
								</div>
							@endif
						</div>
